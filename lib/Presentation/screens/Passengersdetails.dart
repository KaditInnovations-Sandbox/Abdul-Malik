...
class _PassengerspageState extends State<Passengerspage> {
  ...
  //   return Admin.where((admin) {
  //     return admin.firstname.toLowerCase().contains(query.toLowerCase()) ||
  //         admin.vehiclenumber.toLowerCase().contains(query.toLowerCase())||
  //         admin.vehiclenumber.toLowerCase().contains(query.toLowerCase());
  //   }).toList();
  // }
                      ...
                      rows: users
                        ...
                        return DataRow(
                          ...
                          cells: [
                            ...
                            DataCell(
                              Text(
                                  index.isOdd ? "InActive": "Active",
                                style: TextStyle(color: index.isOdd ? Colors.red: Colours.green),
                              ),
                            ),
                            DataCell(
                              IconButton(
